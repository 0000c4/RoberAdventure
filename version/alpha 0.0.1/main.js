...
function output(){
	...
	for (var i = 0; i < HEIGHT; i++)
		for (var j = 0; j < WIDTH; j++)
		{
			...
			if (field[i][j] == 'm1' && monster1.active == 1 && monster1.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm1' && monster1.active == 1 && monster1.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}//вывод тайтла врага если он активен
			
			if (field[i][j] == 'm2' && monster2.active == 1 && monster2.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm2' && monster2.active == 1 && monster2.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}//вывод тайтла врага если он активен
			
			if (field[i][j] == 'm3' && monster3.active == 1 && monster3.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm3' && monster3.active == 1 && monster3.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}//вывод тайтла врага если он активен
			
			if (field[i][j] == 'm4' && monster4.active == 1 && monster4.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm4' && monster4.active == 1 && monster4.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm5' && monster5.active == 1 && monster5.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm5' && monster5.active == 1 && monster5.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm6' && monster6.active == 1 && monster6.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm6' && monster6.active == 1 && monster6.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm7' && monster7.active == 1 && monster7.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm7' && monster7.active == 1 && monster7.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm8' && monster8.active == 1 && monster8.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm8' && monster8.active == 1 && monster8.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm9' && monster9.active == 1 && monster9.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm9' && monster9.active == 1 && monster9.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
			
			if (field[i][j] == 'm10' && monster10.active == 1 && monster10.anim == false){ctx.drawImage(slimeIMG,j*24,i*24)}//вывод тайтла врага если он активен
			else if (field[i][j] == 'm10' && monster10.active == 1 && monster10.anim == true){ctx.drawImage(slimeIMG2,j*24,i*24)}
...
function lvl2(){
	...
	window.monster6 = new enemy(13,2,4,2,"m6");//монстры 
